(function (global, factory) {
	...
	function setToFullScreen(param, canvas) {
	  ...
	  return setStyleHeight(param[5], setStyleWidth(param[4], setHeight(param[3], setWidth(param[2], setY(param[1], setX(param[0], canvas))))));
	}
	...
	function init(param) {
	  ...
	  var gl = createGL(config[/* contextConfig */2], setToFullScreen(getFullScreenData(/* () */0), canvas));
